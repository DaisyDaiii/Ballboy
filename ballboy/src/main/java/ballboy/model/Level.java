...
public interface Level {
    ...
    /**
     *  check whether it is squarecat
     */
    boolean isCat(Entity entity);


    void setScore(ChangeScore score);

    void setChangeLevel(ChangeLevel cl);

    /**
     *  change to the state stored in memento
     */
    void changeLevel(int n, List<Entity> en, List<Integer> score);

    /**
     *  clone enetities
     */
    List<Entity> cloneEntity();

    ChangeLevel getChangeLevel();
