...
public class DynamicEntityImpl extends DynamicEntity implements Cloneable{
    ...
    public DynamicEntityImpl cloneEntity(){
        try {
            DynamicEntityImpl dynamic = null;
            dynamic = (DynamicEntityImpl) super.clone();
            dynamic.kinematicState = this.kinematicState.copy();
            dynamic.volume = this.volume.copy();
            return dynamic;
