 ...
 */
public class ControllableDynamicEntity<T extends DynamicEntity> extends DynamicEntity implements Cloneable {
    ...
    public ControllableDynamicEntity cloneEntity(){
        try {
            ControllableDynamicEntity entity = null;
            entity = (ControllableDynamicEntity) super.clone();
            entity.entity = (DynamicEntity) this.entity.cloneEntity();
            return entity;
